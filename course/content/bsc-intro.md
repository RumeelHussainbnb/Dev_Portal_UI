# Introduction to BNB Smart Chain 

## Lesson Objectives

*By the end of this lesson, you will be able to:*

- Have an understanding of the BNB Smart Chain
- Have an understanding of the consensus mechanism of BNB Smart Chain
- Have an understanding of Token Economy of BNB Smart Chain
- Have an understanding of the Rewards and Slashing
- Have an understanding of Staking, Validators and Governance

## TL;DR
- BNB Smart Chain is the EVM-compatible component with the power of smart contract programmability. 
- The consenssu mechanism used by BNB Chain is reffered to as the Proof of Staked Authority (PoSA).
- It has a block time of 3 seconds.
- All the BSC validators in the current validator set will be rewarded with transaction fees in BNB. As BNB is not an inflationary token, there will be no mining rewards. Holding BNB tokens results in benefits for all stakers and validators.
- Slashing mechanism is used for controlling the bad behavior by validators. 

## Overview
BNB Smart Chain is the core component that is responsible for providing proprogrammability and interoperability to BNB Chain. In this lesson, we provide a brief overview of the BNB Smart Chain, the consensus mechanism used, a general overview of the token economy and the role of validators in the ecosystem.

## BNB Smart Chain 

BNB Smart Chain is an innovative solution to bring programmability and interoperability to BNB Chain. BNB Smart Chain relies on a system of 50 validators with Proof of Staked Authority (PoSA) consensus that can support short block time and lower fees. The most bonded validator candidates of staking will become validators and produce blocks. The double-sign detection and other slashing logic guarantee security, stability, and chain finality. 
