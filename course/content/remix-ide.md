# Using Remix IDE for Compiling and Deploying the Smart Contracts
...
## Demo 
In this lesson, we provide guidelines on how to create, compile, and deploy a simple Hello World smart contract on BSC using the [Remix IDE](https://remix.ethereum.org/). For this hands-on guide, readers are encourged to perform the specified tasks along for a better understanding. 
...
- Step1: Click on the ![img](https://user-images.githubusercontent.com/93580180/214940530-ed29ecb4-9f57-4357-b179-033a0c81b3cf.png) button to switch to compile page.
...
- Step4: Select _HelloWorld_ from the contract drop-down menu.
...
- Head over to [Faucet](https://testnet.binance.org/faucet-smart) and request test BNB tokens.
