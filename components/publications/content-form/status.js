        ...
        <>
          ...
          <div className="relative">
            <div className="inline-flex shadow-sm rounded-md divide-x divide-yellow-600">
              <div className="relative z-0 inline-flex shadow-sm rounded-md divide-x divide-yellow-600">
                <div className="relative inline-flex items-center bg-yellow-500 py-2 pl-3 pr-4 border border-transparent rounded-l-md shadow-sm text-white">
                      ...
                      <div className="flex flex-col">
                        ...
                        <p
                          className={classNames(
                            active ? "text-yellow-200" : "text-gray-500",
                            "mt-2"
                          )}
                        >
                          {option.description}
