        ...
        <div className="mt-1">
          <input
            ...
            className={classNames(
              "py-3 px-4 block w-full shadow-sm focus:ring-yellow-500 focus:border-yellow-500 border-gray-300 rounded-md dark:bg-gray-400 dark:border-gray-500 dark:text-gray-800",
              contentExist &&
