                  ...
                  <div className="justify-evently flex h-fit w-full flex-row flex-wrap px-4">
                    ...
                    <div className="awards-wrap">
                      <div className="w-11 mr-2">
                        <BookOpenIcon className="fill-blue-500 w-full" aria-hidden="true" />
                      </div>
                      <div>
                    ...
                    <div className="awards-wrap">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-9 h-9 fill-yellow-500 mr-2">
                    ...
                    <span className='w-8 h-8 mr-2'>
                      <ThumbUpIcon className="fill-blue-500 w-full" aria-hidden="true" />
                    </span>
                      <div>
