            ...
            <div className="flex w-full gap-3 md:pl-0">
                <main className="">
                    <div className="px-1 sm:px-0">
                        <div className="relative flex flex-col divide-gray-200 rounded-md bg-white p-2 px-6 py-8 shadow dark:divide-gray-700">
                                ...
                                <div className="relative w-28">
                                    <div className="col-span-12 sm:col-span-4 lg:col-span-10">
                                        {isLoading ? (
                                            ...
                                            <img className="absolute h-28 w-28 rounded-full" src={data.ProfilePicture} alt="" />
                                        ) : (
                                            <img
                            ...
                            <p className="flex self-center text-lg font-bold text-black mt-6">
                ...
                <aside className="w-fit">
                    <div className="relative z-0 mt-2 flex flex-col divide-gray-200 rounded-md  bg-white p-2 px-8 py-8 shadow dark:divide-gray-700">
                        ...
                        <div onClick={Addcertificate} className={`mt-2 ml-4 mb-3 flex w-32 cursor-pointer items-center justify-center self-center rounded bg-[#FACC15] p-2 px-4 font-bold text-white`}
                        >
                            Add More
                        </div>

                        <div className={'relative mb-3 flex w-full min-w-0 flex-col break-words bg-white text-white'}>
                            <div className="block w-full overflow-x-auto">
                                            ...
                                            <tbody key={item._id}>
                                                <tr>
                                                    <td className="whitespace-nowrap border-t-0 border-l-0 border-r-0 p-4 px-6 text-xs text-black">
                                                        <Image src={'/certificate.png'} width={'30px'} height={'30px'} />
                                                    </td>
                                ...
                                <div className="flex h-full w-64 items-center py-4 px-8 hidden">
