    ...
    <Container metaTags={metaTags}>
              ...
              handleShowModal(item);
                  ...
                  <div className="flex flex-col align-middle grow-0" >
                    <div className="text-center" >
                      ...
                      alt={item.name}
                    /></div>
                    <div className="text-center"> <Text b size={12}>{item.name}</Text> </div>
                  </div>
             </div>
               <Spacer y={0.5} x={1} />
        </Grid>
      ...
      ))}
      {
              ...
              <div className="closeModal" onClick={handleCloseModal}>
                ...
                <line x1="1.41421" y1="1" x2="19" y2="18.5858" stroke="#8F8F8F" strokeWidth="2" strokeLinecap="round"/>
                <line x1="1" y1="-1" x2="25.8701" y2="-1" transform="matrix(-0.707107 0.707107 0.707107 0.707107 20 1)" stroke="#8F8F8F" strokeWidth="2" strokeLinecap="round"/>
                </svg>
              </div>
