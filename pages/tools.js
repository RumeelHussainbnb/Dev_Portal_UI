...
export default function BNBDevTools() {
  ...
  return (
    <Container metaTags={metaTags}>
      <div className="relative z-0 mt-2 w-11/12 divide-gray-200 rounded-md bg-white p-8 text-sm text-gray-500 shadow dark:divide-gray-700 dark:bg-gray-800 dark:text-gray-500">
        <div className="tools-page overflow-hidden">
          <Grid>
            <div className="tools-wrapper px-4 sm:px-6">
              <h2 className="text-lg-4xl text-center font-bold capitalize tracking-wide text-gray-800 dark:text-gray-300">
